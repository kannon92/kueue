...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WallTimeFlavor) DeepCopyInto(out *WallTimeFlavor) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WallTimeFlavor.
func (in *WallTimeFlavor) DeepCopy() *WallTimeFlavor {
	if in == nil {
		return nil
	}
	out := new(WallTimeFlavor)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WallTimePolicy) DeepCopyInto(out *WallTimePolicy) {
	*out = *in
	if in.WallTimeFlavors != nil {
		in, out := &in.WallTimeFlavors, &out.WallTimeFlavors
		*out = make([]WallTimeFlavor, len(*in))
		copy(*out, *in)
	}
}
