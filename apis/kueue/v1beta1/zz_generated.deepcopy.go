...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BudgetFlavorUsage) DeepCopyInto(out *BudgetFlavorUsage) {
	*out = *in
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
		*out = make([]BudgetUsage, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BudgetFlavorUsage.
func (in *BudgetFlavorUsage) DeepCopy() *BudgetFlavorUsage {
	if in == nil {
		return nil
	}
	out := new(BudgetFlavorUsage)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BudgetPolicy) DeepCopyInto(out *BudgetPolicy) {
	*out = *in
	if in.BudgetGroup != nil {
		in, out := &in.BudgetGroup, &out.BudgetGroup
		*out = make([]BudgetQuotas, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BudgetQuota) DeepCopyInto(out *BudgetQuota) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BudgetQuota.
func (in *BudgetQuota) DeepCopy() *BudgetQuota {
	if in == nil {
		return nil
	}
	out := new(BudgetQuota)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BudgetQuotas) DeepCopyInto(out *BudgetQuotas) {
	*out = *in
	if in.BudgetQuota != nil {
		in, out := &in.BudgetQuota, &out.BudgetQuota
		*out = make([]BudgetQuota, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BudgetQuotas.
func (in *BudgetQuotas) DeepCopy() *BudgetQuotas {
	if in == nil {
		return nil
	}
	out := new(BudgetQuotas)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BudgetUsage) DeepCopyInto(out *BudgetUsage) {
	*out = *in
	out.BudgetTotal = in.BudgetTotal.DeepCopy()
}
...
func (in *ClusterQueueSpec) DeepCopyInto(out *ClusterQueueSpec) {
	*out = *in
	...
	if in.BudgetPolicy != nil {
		in, out := &in.BudgetPolicy, &out.BudgetPolicy
		*out = new(BudgetPolicy)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ClusterQueueStatus) DeepCopyInto(out *ClusterQueueStatus) {
	*out = *in
	...
	if in.BudgetFlavorUsage != nil {
		in, out := &in.BudgetFlavorUsage, &out.BudgetFlavorUsage
		*out = new(BudgetFlavorUsage)
		(*in).DeepCopyInto(*out)
	}
}
