...
// LocalQueueWorkloadDefaultsApplyConfiguration represents a declarative configuration of the LocalQueueWorkloadDefaults type for use
// with apply.
//
...
// specify them.
type LocalQueueWorkloadDefaultsApplyConfiguration struct {
...
// LocalQueueWorkloadDefaultsApplyConfiguration constructs a declarative configuration of the LocalQueueWorkloadDefaults type for use with
// apply.
func LocalQueueWorkloadDefaults() *LocalQueueWorkloadDefaultsApplyConfiguration {
	return &LocalQueueWorkloadDefaultsApplyConfiguration{}
}
...
func (b *LocalQueueWorkloadDefaultsApplyConfiguration) WithMaximumExecutionTimeSeconds(value int32) *LocalQueueWorkloadDefaultsApplyConfiguration {
